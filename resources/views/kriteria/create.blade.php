...
@section('content')
    <div class="container-xl">
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form class="row g-3" method="POST" action="{{ route('kriteria.store') }}">
                    @csrf
                        <div class="col-md-12">
                        ...
                        <div class="col-md-3">
                          ...
                          <input type="text" name="kode" value="{{ old('kode') }}" class="form-control @error('kode') is-invalid @enderror" id="inputEmail4">
                          <span style="color:red;"> @error('kode') {{ $message }} @enderror</span>
                        </div>
                        <div class="col-md-2">
                            <label for="inputEmail4" class="form-label">Bobot (%)</label>
                            <input type="number" name="bobot" value="{{ old('bobot') }}" class="form-control @error('bobot') is-invalid @enderror" id="inputEmail4">
                        ...
                        <div class="col-7">
                            ...
                            <select id="inputState" name="tipe" class="form-select @error('tipe')
                                is-invalid
                            @enderror">
                              <option {{ old('tipe') == 'COST' ? 'selected' : '' }} value="COST">COST</option>
                              <option {{ old('tipe') == 'BENEFIT' ? 'selected' : '' }} value="BENEFIT">BENEFIT</option>
                            </select>
