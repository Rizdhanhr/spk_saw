...
@section('page_title', 'Edit Alternatif')
@section('button')
...
@section('content')
    <div class="container-xl">
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form class="row g-3" method="POST" action="{{ route('alternatif.update',$alternatif->id) }}">
                    @csrf
                    @method('PUT')
                        <div class="col-md-12">
                            <label for="inputEmail4" class="form-label">Nama Alternatif</label>
                            <input type="text" name="nama" value="{{ old('nama',$alternatif->nama) }}" class="form-control @error('nama') is-invalid @enderror" id="inputEmail4">
